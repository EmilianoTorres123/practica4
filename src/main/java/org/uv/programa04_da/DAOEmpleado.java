...
public class DAOEmpleado implements IDAOGeneral<Empleado, Integer> {
    ...
    public Empleado create(Empleado p) {
        ...
        TransaccionDB tbd=new TransaccionDB<Empleado>(p) {
            @Override
    ...
    public boolean delete(Integer id) {
        ConexionDB cx= ConexionDB.getInstance();
        TransaccionDB tbd=new TransaccionDB<Integer>(id) {
            @Override
            public boolean execute(Connection con) {
                try {
    ...
    public List<Empleado> findAll() {
        ...
        ConexionDB cx= ConexionDB.getInstance();
        TransaccionDB tbd=new TransaccionDB<List<Empleado>>(empleados) {
            @Override
            public boolean execute(Connection con) {
                try {
                    List<Empleado> empleados= new ArrayList<>();
